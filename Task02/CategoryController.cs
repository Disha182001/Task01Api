...
namespace Task02
{
    ...
    [Route("api/v{version:apiVersion}/[controller]")]
        [ApiController]
    public class StudentControllerUpdated : ControllerBase
    {
        private readonly IRepo<Student> _repo;
        private readonly IMapper _mapper;
        private readonly ILogger<StudController> _logger;

        public StudentControllerUpdated(IRepo<Student> repo, IMapper mapper, ILogger<StudController> logger)
        {
            _repo = repo;
            _mapper = mapper;
            _logger = logger;
        ...
        public async Task<ActionResult> addStudent(StudentVM student)
        {
            ...
            _logger.LogTrace("Student Created Successfully");
            return Ok(studen);
        }
